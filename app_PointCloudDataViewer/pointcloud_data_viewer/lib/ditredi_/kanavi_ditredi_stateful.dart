...
class KanaviDiTreDiFul extends StatefulWidget {
  ...
  @override
  State<KanaviDiTreDiFul> createState() => _KanaviDiTreDiFulState();
...
class _KanaviDiTreDiFulState extends State<KanaviDiTreDiFul> {
  ...
  Widget build(BuildContext context) {
    return ClipRect(
      child: CustomPaint(
        ...
        painter: widget._mPainter = KanaviCanvasModelPainter(
          widget.figures,
          widget.bounds,
          widget.controller,
          widget.config,
