...
class DynamicDiTreDi extends StatefulWidget {
  ...
  // canvas
  final DynamicCanvasModelPainter canvasModelPainter;

  /// Creates a [DynamicDiTreDi] widget.
  DynamicDiTreDi({
    Key? key,
    required this.figures,
    required this.canvasModelPainter,
  ...
  @override
  State<DynamicDiTreDi> createState() => _DynamicDiTreDiState();
}

class _DynamicDiTreDiState extends State<DynamicDiTreDi> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return ClipRect(
      child: CustomPaint(
        size: Size.infinite,
        painter: widget.canvasModelPainter,
      ),
    );
  }
}
...
class DynamicDiTreDiDraggable extends StatefulWidget {
  ...
  final DynamicCanvasModelPainter canvasModelPainter;
  // fig
  final List<Model3D> figs;

  /// Creates a [DiTreDiDraggable] widget.
  const DynamicDiTreDiDraggable({
    Key? key,
  ...
  @override
  State<DynamicDiTreDiDraggable> createState() =>
      _DynamicDiTreDiDraggableState();
}

class _DynamicDiTreDiDraggableState extends State<DynamicDiTreDiDraggable> {
  var _lastX = 0.0;
  var _lastY = 0.0;
  var _scaleBase = 0.0;
    ...
    return Listener(
      onPointerSignal: (pointerSignal) {
        if (widget.scaleEnabled && pointerSignal is PointerScrollEvent) {
          ...
          setState(() {
            widget.canvasModelPainter.update(
